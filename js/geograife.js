let places = [
    ...
    {
        "name":"See the beautiful Hamnøy",
        "description":"Hamnøy in Lofoten has become known, the world over, for its impressive landscape and unspoilt charm… and it’s easy to see why. Possibly one of the best places in Norway – it’s a spot you should definitely head to without hesitation.",
        "id":"hamony"
    },
    {
        "name":"Visit the tiny village of Reine",
        "description":"Easily, one of the best places in Norway – Reine is picture perfect. Nestled on the island of Moskenesøya it is actually part of the Lofoten set of islands and archipelago that’s made this region so gorgeous. For a stunning experience, wrap up warm (with plenty of layers) and head to Bunes Beach, especially at night. Find a nice spot, lay back on the sandy beach and watch the dancing Northern Lights above you. It really is a special experience.",
        "id":"renee"
    },
    {
        "name":"Explore the Arctic Circle on a Spa Boat",
        "description":"Yup, you head that right! There’s a dedicated spa boat in the Arctic Circle that you can hop on and discover more of the best  places in Norway.  Moored in Tromso, it’s best to book your tickets online and arrive in plenty of time before the boat leaves.",
        "id":"spaboat"
    },
    {
    ...
    },
    {
        ...
        "description":"Runde Island is one of the prettiest and best places in Norway to visit – especially for a tiny little island. You can actually sail directly on a RIB boat from the city of Alesund, which is great if you’re short on time.",
        "id":"runde"
    },
    {
    ...
    },
    {
        ...
        "description":"There are many beautiful fjords in Norway. They’re a dime-a-dozen but some just really stand out, don’t they? For me, that’s Geirangerfjord. Make sure get to the highest viewpoint at Dalsnibba, it’ll take you around 40-minutes to drive but well worth it. Just make sure to pack some thick coats… it gets chilly when you’re this high up.",
        "id":"geiran"
    },
    {
        "name":"Drive the Trollstigen",
        "description":"Between the villages of Åndalsnes and Valldal is the gorgeous Trollstigen drive. Possibly, the most well-known road in Norway, it really is a stunning route to drive.",
        "id":"trollstigen"
    },
    {
        "name":"See Norway’s National Mountain, Stetind",
        "description":"Around 15 miles, or so, from Kjøpsvik – Stetind Mountain is Norway’s national mountain. It’s look is quite different to many other mountains in the area, so you can’t miss it. est of all, if you’re feeling energetic or fancy a challenge, try climbing to the top with a professional guide. Narvik Guides are probably one of the best in the area with all their guides being IFMGA Mountain Guide certified.",
        "id":"stetind"
    },
    {
...
let cities = [
    ...
    {
        "name":"Bodo",
        "description": "As the largest city in the Nordic region, Bodo is an important commercial center and transport hub to the area around it. Although the city itself is uninspiring, architecturally speaking -it was almost completely destroyed in the Second World War – Bodo´s beautiful location, with snow-capped peaks off in the distance, makes up for its drab buildings. Situated at the end of the incredible Kystriksveien Coastal Route, many people visit Bodo to get to the mesmerizing Lofoten Islands nearby. From here you can explore the wild and rugged north of the country – that in itself makes Bodo worth visiting.",
        "id":"bodo"
    },
    {
        "name":"Tromso",
    ...
    $(buttons[0]).on("click", function(){
        ...
        for(let region of regionsLink){
            ...
            $(region[0]).on("mouseover", function(){
                ...
                text.children[1].innerHTML = `Population: ${region[1].population} P/km²`;
            })
        }
